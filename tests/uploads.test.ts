import fs from 'fs';
import type { ResponseLike } from '@vaif/client/internal/to-file';
import { toFile } from '@vaif/client/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@vaif/client/core/uploads');
    await expect(
