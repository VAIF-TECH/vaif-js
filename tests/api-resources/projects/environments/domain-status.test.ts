...
import { BaseDomainStatus } from '@vaif/api/resources/projects/environments/domain-status';
...
const runTests = (client: PartialVaif<{ projects: { environments: { domainStatus: BaseDomainStatus } } }>) => {
