...
import { BaseEnvironments } from '@vaif/api/resources/projects/environments/environments';
...
const runTests = (client: PartialVaif<{ projects: { environments: BaseEnvironments } }>) => {
  ...
  test('environments', async () => {
    const responsePromise = client.projects.environments.environments('projectId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('getEnvironments', async () => {
    const responsePromise = client.projects.environments.getEnvironments('projectId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
