...
import { Org } from '@vaif/api/resources/ai-usage/org/org';
import { BaseSummary } from '@vaif/api/resources/ai-usage/org/summary';
...
const runTests = (client: PartialVaif<{ aiUsage: { org: { summary: BaseSummary } } }>) => {
  test('getSummary', async () => {
    const responsePromise = client.aiUsage.org.summary.getSummary('orgId');
