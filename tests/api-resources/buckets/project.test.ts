...
import { BaseProject } from '@vaif/client/resources/buckets/project';
...
const runTests = (client: PartialVaif<{ buckets: { project: BaseProject } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.buckets.project.retrieve('projectId');
