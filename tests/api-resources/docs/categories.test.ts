...
import { BaseCategories } from '@vaif/api/resources/docs/categories';
...
const runTests = (client: PartialVaif<{ docs: { categories: BaseCategories } }>) => {
  test('list', async () => {
    const responsePromise = client.docs.categories.list();
