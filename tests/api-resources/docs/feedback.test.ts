...
import { BaseFeedback } from '@vaif/api/resources/docs/feedback';
...
const runTests = (client: PartialVaif<{ docs: { feedback: BaseFeedback } }>) => {
  test('create', async () => {
    const responsePromise = client.docs.feedback.create();
