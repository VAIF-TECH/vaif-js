...
import { BaseSearch } from '@vaif/api/resources/docs/search';
...
const runTests = (client: PartialVaif<{ docs: { search: BaseSearch } }>) => {
  test('list', async () => {
    const responsePromise = client.docs.search.list();
