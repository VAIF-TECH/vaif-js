...
import { Quickstart } from '@vaif/api/resources/quickstart/quickstart';
import { BaseProject } from '@vaif/api/resources/quickstart/project/project';
...
const runTests = (client: PartialVaif<{ quickstart: { project: BaseProject } }>) => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.quickstart.project.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { env: 'env', platform: 'web' }, { path: '/_stainless_unknown_path' }))
      .rejects
