...
import { BaseUsage } from '@vaif/api/resources/ai/copilot/usage';
...
const runTests = (client: PartialVaif<{ ai: { copilot: { usage: BaseUsage } } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.ai.copilot.usage.retrieve('projectId');
