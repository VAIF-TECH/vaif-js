...
import { BaseHistory } from '@vaif/api/resources/ai/copilot/deploy/history';
...
const runTests = (client: PartialVaif<{ ai: { copilot: { deploy: { history: BaseHistory } } } }>) => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.ai.copilot.deploy.history.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    limit: 1,
    offset: 0,
    status: 'success',
