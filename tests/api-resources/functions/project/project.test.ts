...
import { BaseProject } from '@vaif/client/resources/functions/project/project';
...
const runTests = (client: PartialVaif<{ functions: { project: BaseProject } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.functions.project.retrieve('projectId');
