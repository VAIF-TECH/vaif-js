...
import { BaseRefresh } from '@vaif/api/resources/oauth/org/provider/refresh';
...
describe('resource refresh (tree shakable, base)', () => runTests(partialClient));
describe('resource refresh (tree shakable, subresource)', () => runTests(parentPartialClient));
