...
import { BaseHealth } from '@vaif/client/resources/regions/health/health';
...
const runTests = (client: PartialVaif<{ regions: { health: BaseHealth } }>) => {
  test('list', async () => {
    const responsePromise = client.regions.health.list();
