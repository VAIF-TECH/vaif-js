...
import { BaseInstall } from '@vaif/api/resources/database/extensions/project/install';
import { Project } from '@vaif/api/resources/database/extensions/project/project';
