...
describe('resource usageAlerts', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.billing.org.usageAlerts.create('orgId', {
      metric: 'ai_credits',
      threshold: 1,
    });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.billing.org.usageAlerts.create('orgId', {
      metric: 'ai_credits',
      threshold: 1,
      notifyEmail: true,
    });
  ...
  test.skip('list', async () => {
    const responsePromise = client.billing.org.usageAlerts.list('orgId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('listConfigured', async () => {
    const responsePromise = client.billing.org.usageAlerts.listConfigured('orgId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveHistory', async () => {
    const responsePromise = client.billing.org.usageAlerts.retrieveHistory('orgId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
