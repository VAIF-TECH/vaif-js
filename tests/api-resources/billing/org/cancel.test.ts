...
import { BaseCancel } from '@vaif/api/resources/billing/org/cancel';
...
const runTests = (client: PartialVaif<{ billing: { org: { cancel: BaseCancel } } }>) => {
  test('cancel', async () => {
    const responsePromise = client.billing.org.cancel.cancel('orgId', {});
