...
import { Billing } from '@vaif/api/resources/billing/billing';
import { BaseRedeemPromo } from '@vaif/api/resources/billing/redeem-promo';
...
describe('resource redeemPromo (tree shakable, base)', () => runTests(partialClient));
describe('resource redeemPromo (tree shakable, subresource)', () => runTests(parentPartialClient));
