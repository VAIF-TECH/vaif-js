...
import { BaseCount } from '@vaif/client/resources/mongodb/count';
...
const runTests = (client: PartialVaif<{ mongoDB: { count: BaseCount } }>) => {
  test('count', async () => {
    const responsePromise = client.mongoDB.count.count('collection');
