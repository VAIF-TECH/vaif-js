...
import { BaseEvents } from '@vaif/api/resources/integrations/analytics/project/events';
import { Project } from '@vaif/api/resources/integrations/analytics/project/project';
...
const runTests = (
  client: PartialVaif<{ integrations: { analytics: { project: { events: BaseEvents } } } }>,
) => {
