...
import { BaseEvent } from '@vaif/api/resources/integrations/deliveries/event';
...
const runTests = (client: PartialVaif<{ integrations: { deliveries: { event: BaseEvent } } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.integrations.deliveries.event.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
