...
import { BaseTest } from '@vaif/api/resources/integrations/subscriptions/test';
...
const runTests = (client: PartialVaif<{ integrations: { subscriptions: { test: BaseTest } } }>) => {
  test('test', async () => {
    const responsePromise = client.integrations.subscriptions.test.test('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
