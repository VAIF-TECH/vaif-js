...
import { Integrations } from '@vaif/api/resources/integrations/integrations';
import { BaseSubscriptions } from '@vaif/api/resources/integrations/subscriptions/subscriptions';
