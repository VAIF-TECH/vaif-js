...
import { Metrics } from '@vaif/api/resources/metrics/metrics';
import { BaseOrg } from '@vaif/api/resources/metrics/org';
...
const runTests = (client: PartialVaif<{ metrics: { org: BaseOrg } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.metrics.org.retrieve('orgId');
