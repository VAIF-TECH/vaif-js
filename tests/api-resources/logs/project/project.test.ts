...
import { Logs } from '@vaif/api/resources/logs/logs';
import { BaseProject } from '@vaif/api/resources/logs/project/project';
...
const runTests = (client: PartialVaif<{ logs: { project: BaseProject } }>) => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.logs.project.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { level: 'info', limit: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
