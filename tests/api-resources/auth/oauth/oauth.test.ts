...
import { BaseOAuth } from '@vaif/api/resources/auth/oauth/oauth';
...
const runTests = (client: PartialVaif<{ auth: { oauth: BaseOAuth } }>) => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.auth.oauth.retrieve('google', { mode: 'login', redirect: 'redirect' }, { path: '/_stainless_unknown_path' }))
      .rejects
