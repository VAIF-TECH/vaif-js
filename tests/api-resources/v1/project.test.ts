...
import { BaseProject } from '@vaif/client/resources/v1/project';
import { V1 } from '@vaif/client/resources/v1/v1';
...
const runTests = (client: PartialVaif<{ v1: { project: BaseProject } }>) => {
  test('list', async () => {
    const responsePromise = client.v1.project.list();
