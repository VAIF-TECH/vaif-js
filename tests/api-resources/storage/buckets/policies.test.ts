...
describe('resource policies', () => {
  ...
  test.skip('create', async () => {
    const responsePromise = client.storage.buckets.policies.create('bucketId');
  ...
  test.skip('list', async () => {
    const responsePromise = client.storage.buckets.policies.list('bucketId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('toggle: only required params', async () => {
    const responsePromise = client.storage.buckets.policies.toggle('policyId', { bucketId: 'bucketId' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('toggle: required and optional params', async () => {
    const response = await client.storage.buckets.policies.toggle('policyId', { bucketId: 'bucketId' });
  });
});
