...
import { Audit } from '@vaif/api/resources/audit/audit';
import { BaseProject } from '@vaif/api/resources/audit/project';
...
const runTests = (client: PartialVaif<{ audit: { project: BaseProject } }>) => {
  test('retrieve', async () => {
    const responsePromise = client.audit.project.retrieve('projectId');
