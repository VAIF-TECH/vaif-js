...
`@vaif/api` ships with a tree-shakable realtime layer for WebSocket subscriptions, presence, and Postgres CDC events:
...
```ts
import { createDropZone } from '@vaif/api/storage/browser';
