...
export class BaseBillingContacts extends APIResource {
  static override readonly _key: readonly ['orgs', 'billingContacts'] = Object.freeze([
    'orgs',
    'billingContacts',
  ] as const);
  ...
  billingContacts(
    orgID: string,
    body: BillingContactBillingContactsParams,
    options?: RequestOptions,
  ): APIPromise<BillingContactBillingContactsResponse> {
  ...
  getBillingContacts(
    orgID: string,
    options?: RequestOptions,
  ): APIPromise<BillingContactGetBillingContactsResponse> {
