...
export class BasePortal extends APIResource {
  static override readonly _key: readonly ['billing', 'portal'] = Object.freeze([
    'billing',
    'portal',
  ] as const);
...
export declare namespace Portal {
  export { type PortalCreateResponse as PortalCreateResponse, type PortalCreateParams as PortalCreateParams };
}
