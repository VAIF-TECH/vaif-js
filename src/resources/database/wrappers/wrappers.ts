...
import { BaseProject, Project, ProjectDeleteParams, ProjectUpdateParams, ProjectUpdateResponse } from './project/project';

export class BaseWrappers extends APIResource {
  static override readonly _key: readonly ['database', 'wrappers'] = Object.freeze(['database', 'wrappers'] as const)
