...
export class BaseUpgradeOptions extends APIResource {
  static override readonly _key: readonly ['projects', 'infrastructure', 'upgradeOptions'] = Object.freeze([
    'projects',
    'infrastructure',
    'upgradeOptions',
  ] as const);
  ...
  getUpgradeOptions(
    instanceID: string,
    params: UpgradeOptionGetUpgradeOptionsParams,
...
export declare namespace UpgradeOptions {
  export { type UpgradeOptionGetUpgradeOptionsParams as UpgradeOptionGetUpgradeOptionsParams };
}
