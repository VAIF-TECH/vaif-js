...
import {
  ...
  DomainVerification,
  DomainVerificationGetDomainVerificationParams,
...
export class BaseEnvironments extends APIResource {
  static override readonly _key: readonly ['projects', 'environments'] = Object.freeze([
    'projects',
    'environments',
  ] as const);
...
export class Environments extends BaseEnvironments {
  ...
  domainVerification: DomainVerificationAPI.DomainVerification = new DomainVerificationAPI.DomainVerification(
    this._client,
  );
