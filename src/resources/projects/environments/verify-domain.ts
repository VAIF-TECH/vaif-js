...
export class BaseVerifyDomain extends APIResource {
  static override readonly _key: readonly ['projects', 'environments', 'verifyDomain'] = Object.freeze([
    'projects',
    'environments',
    'verifyDomain',
  ] as const);
  ...
  verifyDomain(
    envID: string,
    params: VerifyDomainVerifyDomainParams,
...
export declare namespace VerifyDomain {
  export { type VerifyDomainVerifyDomainParams as VerifyDomainVerifyDomainParams };
}
