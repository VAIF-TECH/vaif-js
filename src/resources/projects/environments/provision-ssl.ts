...
export class BaseProvisionSsl extends APIResource {
  static override readonly _key: readonly ['projects', 'environments', 'provisionSsl'] = Object.freeze([
    'projects',
    'environments',
    'provisionSsl',
  ] as const);
  ...
  provisionSsl(
    envID: string,
    params: ProvisionSslProvisionSslParams,
...
export declare namespace ProvisionSsl {
  export { type ProvisionSslProvisionSslParams as ProvisionSslProvisionSslParams };
}
