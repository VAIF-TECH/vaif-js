...
export class BaseVerifyCname extends APIResource {
  static override readonly _key: readonly ['projects', 'environments', 'verifyCname'] = Object.freeze([
    'projects',
    'environments',
    'verifyCname',
  ] as const);
  ...
  verifyCname(
    envID: string,
    params: VerifyCnameVerifyCnameParams,
...
export declare namespace VerifyCname {
  export { type VerifyCnameVerifyCnameParams as VerifyCnameVerifyCnameParams };
}
