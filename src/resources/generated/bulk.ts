...
export class BaseBulk extends APIResource {
  ...
  bulk2(table: string, options?: RequestOptions): APIPromise<void> {
    return this._client.patch(path`/generated/${table}/bulk`, { ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
